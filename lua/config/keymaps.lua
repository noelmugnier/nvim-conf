...
keymap({ "n", "v" }, "<leader>wh", "<ESC><C-w>h", { desc = "Go to editor left" })
-- keymap({ "n", "v" }, "<C-j>", "<ESC><C-w>j")
keymap({ "n", "v" }, "<leader>wj", "<ESC><C-w>j", { desc = "Go to editor below" })
-- keymap({ "n", "v" }, "<C-k>", "<ESC><C-w>k")
keymap({ "n", "v" }, "<leader>wk", "<ESC><C-w>k", { desc = "Go to editor above" })
